...
{
    private static $HEADERS_TO_PERSIST = array('Shipmile-Account' => true, 'Shipmile-Version' => true);

    public static function baseUrl()
    {
        return Shipmile::$apiBase;
    }
    ...
    public static function className()
    {
        ...
        if (substr($class, 0, strlen('Shipmile')) == 'Shipmile') {
            $class = substr($class, strlen('Shipmile'));
        }
    ...
    private static function _validateParams($params = null)
    {
        if ($params && !is_array($params)) {
            $message = "You must pass an array as the first argument to Shipmile API "
                . "method calls.  (HINT: an example call to create a charge "
                . "would be: \"Shipmile\\Charge::create(array('amount' => 100, "
    ...
    protected static function _get($id, $options = null)
    {
        $opts = Util\RequestOptions::parse($options);
    ...
    protected static function _all($params = null, $options = null)
    {
        ...
        return Util\Util::convertToShipmileObject($response, $opts);
    }
