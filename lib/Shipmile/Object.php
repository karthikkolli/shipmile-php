...
class Object implements ArrayAccess
{
    ...
    public function &__get($k)
    {
        if (array_key_exists($k, $this->_values)) {
            ...
            $message = "Shipmile Notice: Undefined property of $class instance: $k. "
                . "HINT: The $k attribute was set in the past, however. "
                . "It was then wiped when refreshing the object "
                . "with the result returned by Shipmile's API, "
            ...
            $class = get_class($this);
            error_log("Shipmile Notice: Undefined property of $class instance: $k");
            return null;
        }
    }
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
                ...
                $this->_values[$k] = Util\Util::convertToShipmileObject($v, $opts);
            }
    ...
    {
        if ($recursive) {
            return Util\Util::convertShipmileObjectToArray($this->_values);
        } else {
            return $this->_values;
        }
    }
